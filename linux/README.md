...
Since the application is fully containerized, you do not need to install Python. The only requirement is having Docker installed.

1. Ensure the standard Docker engine (docker-ce) is installed.
2. Ensure your user has permission to run docker commands without sudo (your user must belong to the docker group).
